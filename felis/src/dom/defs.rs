...
macro_rules! ComObject_Node {
    ($impl_type: ty) => {
        ...
        mod Node_crosscom_impl {
            ...
            pub const GLOBAL_INodeVirtualTable_CCW_FOR_Node:
                crate::dom::defs::INodeVirtualTableCcw = crate::dom::defs::INodeVirtualTableCcw {
                offset: 0,
...
macro_rules! ComObject_Element {
    ($impl_type: ty) => {
        ...
        mod Element_crosscom_impl {
            ...
            #[allow(non_upper_case_globals)]
            pub const GLOBAL_IElementVirtualTable_CCW_FOR_Element:
...
macro_rules! ComObject_Text {
    ($impl_type: ty) => {
        ...
        mod Text_crosscom_impl {
            ...
            #[allow(non_upper_case_globals)]
            pub const GLOBAL_ITextVirtualTable_CCW_FOR_Text:
                crate::dom::defs::ITextVirtualTableCcw = crate::dom::defs::ITextVirtualTableCcw {
                offset: 0,

...
,    pub get: unsafe extern "system" fn (this: *const *const std::os::raw::c_void, index: std::os::raw::c_int, 
...
unsafe extern "system" fn get (this: *const *const std::os::raw::c_void, index: std::os::raw::c_int, 
) -> *const *const std::os::raw::c_void {
    let object = crate::get_object::<ObjectArrayCcw>(this);

...
,    pub GetCount: unsafe extern "system" fn (this: *const *const std::os::raw::c_void, ) -> std::os::raw::c_int
,    pub GetItem: unsafe extern "system" fn (this: *const *const std::os::raw::c_void, index: std::os::raw::c_int, 
...
pub fn GetCount (&self, ) -> i32
 {
    unsafe {
        let this = self as *const IObjectArray as *const *const std::os::raw::c_void;
        ((*self.vtable).GetCount)(this, ).into()
    }
}


pub fn GetItem (&self, index: i32, 
) -> crate::ComRc<IUnknown>
 {
    unsafe {
        let this = self as *const IObjectArray as *const *const std::os::raw::c_void;
        ((*self.vtable).GetItem)(this, index).into()
    }
}
...
fn GetCount (&self, ) -> i32
;
fn GetItem (&self, index: i32, 
) -> crate::ComRc<IUnknown>
;
}
...
unsafe extern "system" fn GetCount (this: *const *const std::os::raw::c_void, ) -> std::os::raw::c_int {
    let object = crate::get_object::<ObjectArrayCcw>(this);
    (*object).inner.GetCount().into()
}



unsafe extern "system" fn GetItem (this: *const *const std::os::raw::c_void, index: std::os::raw::c_int, 
) -> *const *const std::os::raw::c_void {
    let object = crate::get_object::<ObjectArrayCcw>(this);
    (*object).inner.GetItem(index).into()
}
...
pub const GLOBAL_IObjectArrayVirtualTable_CCW_FOR_ObjectArray: crate::IObjectArrayVirtualTableCcw 
    = crate::IObjectArrayVirtualTableCcw {
    offset: 0,
